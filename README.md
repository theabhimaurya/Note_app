...
A modern, clean, and feature-rich Notes application built with **Jetpack Compose** and **Supabase**. This app follows clean architecture principles and provides a seamless user experience for managing daily thoughts and tasks.

## 🚀 Features

- **User Authentication**: Secure Sign In and Sign Up flows with real-time validation.
...
- **Interactive Notes Management**:
    ...
    - **Add/Edit Notes**: Integrated bottom sheet editor with validation.
